...
<div id="gantEditorTemplates" style="display:none;">
  ...
  <span onmouseover="ShowText('Messageqq'); return true;" onmouseout="HideText('Messageqq'); return true;" href="javascript:ShowText('Messageqq')">
    <div class="layout (#=obj.hasExternalDep?'extDep':''#)" style="background-color:(#=obj.level==0?"#808080":(obj.level==1?"#A9A9A9":(((obj.level==2)&&(obj.full_mes==0))?"#ADD8E6":"#b4f3b4"))#);">  
        ...
        <div id="Messageqq" class="taskLabel boxix"><tr><tr><font color=(#=obj.full_mes>0?"#006600":"#FFFFFF"#)>( (#=obj.now_mes#) / (#=obj.full_mes#) ) - (#=obj.progress#)%</font></tr><br><tr><font color="#3300CC">( (#=obj.fnow_mes#) / (#=obj.ffull_mes#) ) - (#=obj.fprogress#)%</font></tr></tr></div>
...
//alert(packtask);
  var 	strURL =  "getpacktask.php?packtask="+packtask+"&project="+<?= $proj;?> ;
   ...
   location.replace('gantt.php?proj='+<?= $proj;?>+'&packtask='+propacktask.options[propacktask.selectedIndex].value);
  }
</script> 
